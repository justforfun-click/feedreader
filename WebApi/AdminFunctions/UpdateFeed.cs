...
namespace FeedReader.WebApi.AdminFunctions
{
    public static class UpdateFeedFunc
    {
        ...
        public static Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "@admin/update-feed")] HttpRequest req,
            ILogger log)
        {
            return HttpFilter.RunAsync(req, async () =>
            {
                ...
                await UpdateFeed(feedUri, Backend.Share.AzureStorage.GetFeedsTable(), Backend.Share.AzureStorage.GetFeedItemsTable(), Backend.Share.AzureStorage.GetLatestFeedItemsTable(), log);
                return new OkResult();
            });
        }
